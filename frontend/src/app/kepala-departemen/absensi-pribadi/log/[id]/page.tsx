...
export default function LogAbsensiKepalaDepartemenPage() {
      ...
      <div className="min-h-screen bg-gray-100 pb-28">
        ...
        <div className="px-5 pt-3 pb-4">
          <div className="flex items-center gap-4">
            <button onClick={() => router.back()} className="bg-gray-100 text-gray-700 px-4 py-2 rounded-lg text-sm font-medium hover:bg-gray-200 transition-colors flex items-center gap-2">

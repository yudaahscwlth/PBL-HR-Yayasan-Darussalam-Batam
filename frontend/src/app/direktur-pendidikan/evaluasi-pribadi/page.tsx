...
export default function DirekturPendidikanEvaluasiPribadiPage() {
    ...
    const fetchData = async () => {
      try {
        ...
        if (evalRes?.success && evalRes.data) {
          ...
          // Set default to first tahun ajaran or active one
                              ...
                              {[5, 4, 3, 2, 1].map((score) => (
                                <td key={score} className="p-3 border-b border-gray-200 text-center">
                                  <input
                                    ...
                                    disabled
                                    className="w-5 h-5 text-sky-800 cursor-not-allowed  "
                                  />
                                </td>
                              ))}
                            </tr>

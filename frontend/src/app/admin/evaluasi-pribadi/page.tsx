...
export default function AdminEvaluasiPribadiPage() {
                    ...
                    {catatan && (
                      <div className="space-y-2">
                        ...
                        <textarea
                          ...
                          disabled
                          rows={4}
                          className="w-full px-4 py-3 border border-gray-300 rounded-lg bg-gray-100 cursor-not-allowed resize-none"
                        />
                      </div>
                    )}
                  </>

    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="bg-white px-4 py-4 border-b border-gray-200">
        <div className="flex items-center justify-between">
          ...
          <h1 className="text-lg font-semibold text-gray-800">Tahun Ajaran</h1>
      ...
      <div className="p-4">
        <div className="bg-white rounded-lg p-6 text-center">
          ...
          <h2 className="text-xl font-semibold text-gray-800 mb-2">Tahun Ajaran</h2>
          <p className="text-gray-600 mb-4">Fitur ini akan segera tersedia</p>
          <p className="text-sm text-gray-500">Anda dapat mengelola data tahun ajaran di sini</p>
        </div>
      </div>
    </div>
  );

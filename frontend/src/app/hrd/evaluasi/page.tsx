    ...
    const fetchData = async () => {
      try {
        ...
        const [usersRes, kategoriRes, tahunRes] = await Promise.all([
          axios.get(`${process.env.NEXT_PUBLIC_API_URL || 'http://localhost:8000'}/api/users`, { headers }),
          ...
          <div className="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden">
            <form onSubmit={handleSubmit} className="p-6 md:p-8 space-y-8">
              ...
              <div className="space-y-6">
                <h2 className="text-xl font-semibold text-gray-800 border-b pb-4">Evaluasi</h2>
              ...
              <div className="space-y-6">
                ...
                <div className="space-y-2">
                  ...
                  <textarea
                    ...
                    rows={4}
                    disabled={evaluationExists}
                    className={`w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-sky-800 focus:border-sky-800 outline-none resize-none ${evaluationExists ? 'bg-gray-100 cursor-not-allowed' : ''}`}

...
export default function KepalaSekolahEvaluasiPage() {
                ...
                <div className="max-w-full mx-auto">
                    ...
                    <div className="px-5 pt-3 pb-4">
                        <div className="flex items-center gap-4">
                            ...
                            <h1 className="text-xl font-bold text-gray-800">Evaluasi</h1>
                        </div>
                    </div>
                                ...
                                <div className="space-y-6">
                                    ...
                                    <div className="grid gap-6 max-w-lg">
                                        ...
                                        <div className="flex items-center gap-2">
                                            ...
                                            <span
                                                className={`px-3 py-1 text-white text-xs font-medium rounded-md ${evaluationExists ? "bg-green-600" : "bg-gray-400"
                                                    }`}
                                            >
                                ...
                                <div className="space-y-6">
                                                        ...
                                                        {[5, 4, 3, 2, 1].map((score) => (
                                                            ...
                                                            >
                                                                <input
                                                                    ...
                                                                    className={`w-5 h-5 text-sky-800 focus:ring-sky-800 ${evaluationExists
                                    ...
                                    <div className="space-y-2">
                                        ...
                                        <textarea
                                            ...
                                            rows={4}
                                            disabled={evaluationExists}
                                            className={`w-full px-4 py-3 border border-gray-300 text-gray-700 rounded-lg focus:ring-2 focus:ring-sky-800 focus:border-sky-800 outline-none resize-none ${evaluationExists ? "bg-gray-100 cursor-not-allowed" : ""
                                                }`}

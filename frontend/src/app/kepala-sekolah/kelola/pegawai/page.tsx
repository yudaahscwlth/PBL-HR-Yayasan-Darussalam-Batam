...
function ActionMenuPortal({
    ...
    const menu = (
        ...
        >
            <Link
                href={`/kepala-sekolah/profile/${userId}`}
            ...
            <Link
                href={`/kepala-sekolah/absensi/${userId}`}
                className="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-50 hover:text-sky-800 flex items-center gap-2"
            >
            ...
            <Link
                href={`/kepala-sekolah/cuti/${userId}`}
                className="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-50 hover:text-sky-800 flex items-center gap-2"
            >
            ...
            <Link
                href={`/kepala-sekolah/evaluasi/${userId}`}
                className="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-50 hover:text-sky-800 flex items-center gap-2"
            >
...
export default function KepalaSekolahKelolaPegawaiPage() {
                        ...
                        <div className="flex flex-col md:flex-row justify-between gap-4 mb-6">
                            ...
                            <div className="flex gap-2">
                                <button
                                    ...
                                    className={`px-4 py-2 rounded-md flex items-center gap-2 text-sm font-medium transition-colors ${showFilter

...
export default function NetworkStatus() {
  ...
  // Jangan render apapun sampai client mounted untuk mencegah hydration mismatch
  ...
  return (
    <div
      className={`fixed top-0 left-0 right-0 z-50 text-white px-4 py-3 shadow-lg transition-colors ${

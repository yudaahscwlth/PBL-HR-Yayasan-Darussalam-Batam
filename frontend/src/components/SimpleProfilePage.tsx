...
export default function SimpleProfilePage() {
  ...
  useEffect(() => {
    console.log("=== SIMPLE PROFILE PAGE USEEFFECT ===");
    ...
    // If we have user data, show profile (no role restrictions)
    if (user) {
      console.log("✅ Access granted to profile for user:", user.email);
      console.log("✅ User roles:", user.roles);
      setIsLoading(false);
    }
      ...
      <div className="px-4 py-6">
        ...
        <div className="mb-6">
          ...
          <div className="bg-white rounded-lg border border-gray-200 overflow-hidden">
            {accountMenu.map((item, itemIndex) => (
              <div key={itemIndex}>
